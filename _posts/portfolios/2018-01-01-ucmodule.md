...
사용자와 연락처 엔티티를 매핑하였고 Persistant API를 이용하여 SQL 명시를 최대한 줄이고,   
...
## 시연 영상
 {% include testing-ucmodule.html id="xw-3VIGQBrM" %}  
## 프로젝트 회고
